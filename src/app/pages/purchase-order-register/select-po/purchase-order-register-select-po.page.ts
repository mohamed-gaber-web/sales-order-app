...
@Component({
  selector: 'app-purchase-order-register-select-po',
  templateUrl: './purchase-order-register-select-po.page.html',
  styleUrls: ['./purchase-order-register-select-po.page.scss'],
  standalone: false,
})
export class PurchaseOrderRegisterSelectPoPage {
  searchTerm = '';
  showDropdown = false;
  isSearching = false;
  ...
  selectPo(po: PurchaseOrderHeader) {
    this.showDropdown = false;
    this.router.navigate(['/purchase-order-register', po.PurchaseOrderNumber]);
  }
