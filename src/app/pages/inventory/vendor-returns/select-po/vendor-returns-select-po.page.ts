...
@Component({
  selector: 'app-vendor-returns-select-po',
  templateUrl: './vendor-returns-select-po.page.html',
  styleUrls: ['./vendor-returns-select-po.page.scss'],
  standalone: false,
})
export class VendorReturnsSelectPoPage {
  searchTerm = '';
  showDropdown = false;
  isSearching = false;
  ...
  selectPo(po: PurchaseOrderHeader) {
    this.showDropdown = false;
    this.router.navigate(['/inventory/vendor-returns/scan', po.PurchaseOrderNumber]);
  }
